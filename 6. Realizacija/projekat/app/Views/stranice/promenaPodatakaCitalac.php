                ...
                <form action="<?php echo site_url($controller."/noviPodaci")?>" method="post">
                    <table class="table userpass">
                        ...
                        <tr>
                            ...
                            <td>
                                <input value="<?php echo set_value("broj", $citalac->BrojKartice)?>" name="broj" type="text" inputmode="numeric" pattern="[0-9\s]{13,19}" autocomplete="cc-number" maxlength="19" placeholder="xxxx xxxx xxxx xxxx">
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>
                                <div class="cvv-input">
                                    <input value="<?php echo set_value("cvv", $citalac->CVV)?>" name="cvv" type="password" inputmode="numeric" placeholder="CVV" maxlength="4">
                                </div>
                            </td>
                            <td>
